...
jQuery(document).ready(function($) {
    ...
    const DiscordAuthConfig = {
        ...
        bindEvents: function() {
            // Save OA        clearAddRoleForm: function() {
            $('#new_role_name').val('');
            $('#new_role_id').val('');
        },
            ...
            const roleHtml = `
                <div class="discord-role-item" data-role-key="${roleKey}">
                    ...
                    <div class="role-input">
                        ...
                        />
                        <button type="button" class="button remove-role" data-role-key="${roleKey}">
                            Remove
                        </button>
                    </div>
                </div>
        ...
        saveDiscordRoles: function(e) {
            ...
            // Also collect dynamically added roles
            $('.dynamic-role-item').each(function() {
                const $item = $(this);
                const name = $item.find('.role-name').val();
                const roleId = $item.find('.role-id').val();
